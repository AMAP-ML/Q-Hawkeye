...
_deps = [
    ...
    "isort>=5.12.0",
    # "liger_kernel==0.5.2",
    # "lighteval",  # "lighteval @ git+https://github.com/huggingface/lighteval.git@4f381b352c0e467b5870a97d41cb66b487a2c503#egg=lighteval[math]",
    ...
    # "torch>=2.5.1",
    "transformers",  # "transformers @ git+https://github.com/huggingface/transformers.git@main",
    "trl",  # "trl @ git+https://github.com/huggingface/trl.git@main",
    "vllm==0.7.2",  # "vllm==0.6.6.post1",
    "wandb>=0.19.1",
    "pillow",
]
